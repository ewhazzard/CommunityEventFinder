...
def test_event_with_city_of_interest():
    ...
    assert list[0].get_event_details().get_contact_info().get_location().get_city() != "Chicago"
    assert list[1].get_event_details().get_contact_info().get_location().get_city() == "Chicago"
